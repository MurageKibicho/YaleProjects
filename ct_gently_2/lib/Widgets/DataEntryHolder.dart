...
class DataEntryHolder extends StatefulWidget {
  final double height;
  final double width;
  ...
  const DataEntryHolder({Key key, this.height, this.width, this.fieldName, this.fieldNameFontSize, this.displayValue, this.displayValueFontSize, this.scrollHeight, this.scrollWidth, this.scrollViewItemExtent, this.scrollChild, this.setValue}) : super(key: key);

  @override
  _DataEntryHolderState createState() => _DataEntryHolderState();
}

class _DataEntryHolderState extends State<DataEntryHolder> {
