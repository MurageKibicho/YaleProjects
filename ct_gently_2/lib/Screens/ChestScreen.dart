...
class _ChestScreenState extends State<ChestScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final Equations = Provider.of<ChestEquationsProvider>(context);
            ...
            children:<Widget>[
              ...
              Container(
                ...
                child: Column(children: <Widget>[
                  ...
                  GestureDetector(
                      onTap:() => DialogUtils.showCustomDialog(context, title: "Lung Circumference", okBtnFunction: null,
                        child: Container(
              ...
              Container(
                ...
                child: Column(
                  children:<Widget>[
                    ...
                    Equations.CTChestOptimumMASCalc().toInt().toString()
                        :
                    Equations.CBCTChestOptimumMASCalc().toInt().toString(),
                      style: GoogleFonts.playfairDisplay(
                        fontSize: 20,
                        fontWeight: FontWeight.normal,
                        fontStyle: FontStyle.normal,
              ...
              Container(
                ...
                child: Column(
                  children:<Widget>[
                    ...
                    Text(Equations.isCTSelected[0] ?
                    Equations.CTChestOptimumKVPCalc().toInt().toString()
                        :
                    Equations.CBCTChestOptimumKVPCalc().toInt().toString(),
                      style: GoogleFonts.playfairDisplay(
                        fontSize: 20,
                        fontWeight: FontWeight.normal,
                        fontStyle: FontStyle.normal,
          ...
          Row(
            children: <Widget>[
              Container(
                ...
                child: Column(
                  children: [
                    BarChartSample1(doseInt:Equations.CTChestOptimumDose(),
                      riskInt: Equations.sex ? Equations.CTChestMaleOptimumRisk() : Equations.CTChestFemaleOptimumRisk(),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    BarChart2(doseInt:Equations.CTChestReferralDose(),
                      riskInt:(Equations.sex ? Equations.CTChestMaleReferralRisk() : Equations.CTChestFemaleReferralRisk()),
